...
values ('fii', '2019-12-31', 0, 0, 0, 0.00, 0.00);

insert into ativo (id, ticker, nome, tipo, setor, qtde, valor_total_investido, data_entrada, cnpj_fundo, valor_investido_dolares)
VALUES (1, 'visc11', 'Vinci Shoppings', 'fii', 'shoppings', 200, 35000.00, '2019-12-01', null, 0.00);

insert into ativo (id, ticker, nome, tipo, setor, qtde, valor_total_investido, data_entrada, cnpj_fundo, valor_investido_dolares)
VALUES (2, 'brcr11', 'bc fund', 'fii', 'lajes corporativas', 100, 12000.00, '2019-11-01', null, 0.00);
